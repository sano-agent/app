 ...
 * ============================================================================
 * PROJETO: SanoAgent - Quem canta seus males espanta
 * TEMA: Musica, bem-estar e psicologia positiva
 *
 * DESCRIÇÃO:
...
var THEME_NEWS_CFG = {
  THEME: 'Musica, bem-estar e psicologia positiva',
  QUERY: 'musicoterapia OR "musica na educacao"',
  AUDIENCE: 'criancas que transformam pensamentos positivos em letras de Rock e Tropicalia',
