...
// FROTA-PROMPT-02: Ordem padrao da frota: ID, Username, Password, Role
const SYNTHETIC_USERS_LOGIN_SCHEMAS = [
  { sheetName: 'Usuarios', headers: ['ID','Username','Password','Role'] }
];
