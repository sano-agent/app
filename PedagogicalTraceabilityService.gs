      ...
      var PedagogicalTraceabilityService = (function () {
        var CFG = {
          projectName: "Sano Agent - Quem canta seus males espanta",
          shortName: "Sano Agent",
          theme: "expressao emocional, poesia e composicao musical",
          sourceStrategy: "A composicao deve ligar tema escolhido, rascunho, estilo musical e versao final, sem transformar feedback criativo em julgamento.",
          learnerAgency: "O estudante decide o que manter, cantar ou compartilhar; a IA e oficina de linguagem, nao banca avaliadora.",
          evidenceLabel: "tema, tags emocionais, recursos poeticos e revisoes do rascunho",
          productLabel: "letra refinada, feedback criativo ou registro de portfolio",
          reviewFocus: [
  "O feedback valoriza expressao antes de sugerir ajuste tecnico?",
  "A letra preserva consentimento para compartilhamento ou performance?",
  "As sugestoes tratam rima, ritmo e imagem poetica sem apagar autoria?",
  "Temas sensiveis aparecem com acolhimento, nao com censura automatica?"
]
        };
